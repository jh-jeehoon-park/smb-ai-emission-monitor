    ...
    <div className="space-y-6">
      ...
      <Panel
        ...
        titleAside={
          <InfoTip
            label="이 값의 출처"
            content={`수위는 원문의 «배출 데이터» 3종 중 하나입니다. 다만 단위·범위·측정 방식이 원문에 없습니다 — 그래서 이 화면은 만수위를 주장하지 않습니다. 세로축은 0에서 그날 최댓값까지이고, 곁의 «오늘 …»이 실제로 오간 폭입니다. 방류를 멈추면 처리수가 계속 들어와 차오르고, 재개하면 빠집니다. 위 유량 차트와 같은 시간축이라 옅은 띠가 두 그림에서 같은 자리에 섭니다.`}
          />
        }
      >
        {pending ? (
